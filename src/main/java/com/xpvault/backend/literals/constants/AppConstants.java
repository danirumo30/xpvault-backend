...
public final class AppConstants {
    ...
    public static final String NO_STEAM_DETAILS = "No details found for Steam ID: %d";
    ...
    public static final String MOVIE_TITLE_NOT_FOUND = "No movies found with title: %s";
    public static final String MOVIE_GENRE_NOT_FOUND = "No movies found with genre: %s";
    ...
    public static final String TV_SERIE_TITLE_NOT_FOUND = "No TV Series found with title: %s";
    public static final String TV_SERIE_GENRE_NOT_FOUND = "No TV Series found with genre: %s";
    ...
    public static final String STEAM_ID_NOT_FOUND_FOR_USERNAME = "SteamID not found for username: %s";
    public static final String USERNAME_NOT_FOUND_FOR_STEAM_ID = "Username could not be resolved by ID: %d";
